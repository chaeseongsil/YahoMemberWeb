...
public class Member {
	...
	public Member(String memberId, String memberPw, String memberGender, String memberEmail, String memberAddress,
			String memberPhone, String memberHobby) {
		super();
		this.memberId = memberId;
		this.memberPw = memberPw;
	...
	public Member(String memberId, String memberPw, String memberName, int memberAge, String memberGender,
			String memberEmail, String memberAddress, String memberPhone, String memberHobby) {
		super();
		this.memberId = memberId;
		this.memberPw = memberPw;
